...
Análise da Demonstração do Resultado (DRE) – Embraer (v3 – Nekt Cloud)
Autor: Ricardo Diniz
Ferramenta: Power BI
Plataforma: Nekt
Tecnologias: SharePoint Connector, Data Lake Medallion, PySpark, Google Colab, Google BigQuery (native)
...
1.1 Justificativa	3
1.2 Plataforma Utilizada	3
2. Arquitetura da Solução	4
2.1 Visão Geral da Arquitetura	4
2.2 Camadas do Data Lake	4
2.2.1 Camada Bronze (Raw Data)	4
2.2.2 Camada Silver (Trusted Data)	4
2.2.3 Camada Gold (Business Data)	5
2.3 Tecnologias Utilizadas	5
3. Desenvolvimento do Projeto	6
3.1 Criação do Workspace e do Data Lake	6
3.2 Ingestão dos dados da DRE com o conector SharePoint	7
3.3 Estrutura do catálogo e publicação das camadas	7
3.4 Desenvolvimento dos notebooks em PySpark	8
3.4.1 Notebook 01 – Transformações de PlanoConta na Silver	8
3.4.2 Notebook 02 – Transformações de Resultado na Silver	10
3.4.3 Notebook 03 – Publicação de dPlanoConta na Gold	11
3.4.4 Notebook 04 – Publicação de ftResultado na Gold	12
3.5 Integração com o Power BI	13
3.5.1 Configuração da Conexão	13
3.5.2 Benefícios da Integração	13
3.6 Orquestração do Pipeline	14
3.6.1 Estrutura do Pipeline	14
3.6.2 Lógica de Orquestração	14
3.7. Evolução da Solução	15
3.7.1 Comparativo entre Projetos	15
3.7.2 Ganhos Obtidos	15
3.8 Resultado para o Negócio	15
3.9 Conclusão da etapa de desenvolvimento	16
4. Dicionário de Dados	17
4.1 Tabela dPlanoConta	17
4.1.1 Descrição da Tabela	17
4.1.2 Estrutura da Tabela	18
4.2 Tabela ftResultado	19
4.2.1 Descrição da Tabela	19
4.2.2 Estrutura da Tabela	19
5. Entrega de Valor	20
5.1 Perspectiva de Negócio	20
5.2 Perspectiva Técnica	20
5.3 Consolidação da Entrega	21
...
Negócio:
Garante consistência do pipeline, evita processamento de dados incompletos, reduz a intervenção manual, padroniza a atualização e fortalece a confiabilidade do processo de ponta a ponta.________________________________________

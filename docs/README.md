...
- [Justificativa](./01_justificativa.md)
- [Arquitetura](./02_arquitetura.md)
- [Desenvolvimento](./03_desenvolvimento.md)
- [Dicionário de Dados](./04_dicionario_dados.md)
- [Entrega de Valor](./05_entrega_valor.md)


# 📄 Documentação do Projeto

Esta pasta contém toda a documentação técnica e de negócio do projeto DRE Embraer.
...
Garantir rastreabilidade entre negócio, arquitetura e implementação técnica.
